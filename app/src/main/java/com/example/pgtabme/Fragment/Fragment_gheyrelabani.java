...
public class Fragment_gheyrelabani extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public static Fragment newInstance() {
        ...
        Fragment_gheyrelabani fragment = new Fragment_gheyrelabani();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = null;
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_gheyrelabani, container, false);
        }
        if (dataModels != null) {
            dataModels.clear();
        }
...
//        recyclerView.setAdapter(adapter);
        ...
        Call<ArrayList<DataModel>> call = apiInterface.getgheyrelabani();
