...
public class Fragment_sayerdogh extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public static Fragment newInstance() {
        ...
        Fragment_sayerdogh fragment = new Fragment_sayerdogh();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = null;
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_sayerdogh, container, false);
        }
        if (dataModels != null) {
            dataModels.clear();
        }
...
//        recyclerView.setAdapter(adapter);
        ...
        Call<ArrayList<DataModel>> call = apiInterface.getsayerdogh();
