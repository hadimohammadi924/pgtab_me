...
public class Fragment_paniruf extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public static Fragment newInstance() {
        ...
        Fragment_paniruf fragment = new Fragment_paniruf();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = null;
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_paniruf, container, false);
        }
        if (dataModels != null) {
            dataModels.clear();
        }
...
//        recyclerView.setAdapter(adapter);
        ...
        Call<ArrayList<DataModel>> call = apiInterface.getpaniruf();
