...
public class Fragment_abmiveyeklitri extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public static Fragment newInstance() {
        ...
        Fragment_abmiveyeklitri fragment = new Fragment_abmiveyeklitri();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = null;
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_abmiveyeklitri, container, false);
        }
        if (dataModels != null) {
            dataModels.clear();
        }
    ...
    //  adapter=new RecyclerAdapter(dataModels);
       recyclerView.setAdapter(adapter);
        ...
        Call<ArrayList<DataModel>> call = apiInterface.getabmiveyeklitri();
