...
public class Fragment_mosir extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public static Fragment newInstance() {
        ...
        Fragment_mosir fragment = new Fragment_mosir();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = null;
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_mosir, container, false);
        }
        if (dataModels != null) {
            dataModels.clear();
        }
...
//        recyclerView.setAdapter(adapter);
        ...
        Call<ArrayList<DataModel>> call = apiInterface.getmosir();
