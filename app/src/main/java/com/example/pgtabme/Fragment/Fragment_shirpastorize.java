...
public class Fragment_shirpastorize extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public static Fragment newInstance() {
        ...
        Fragment_shirpastorize fragment = new Fragment_shirpastorize();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = null;
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_shirpastorize, container, false);
        }
        if (dataModels != null) {
            dataModels.clear();
        }
...
//        recyclerView.setAdapter(adapter);
        ...
        Call<ArrayList<DataModel>> call = apiInterface.getshirpastorize();
